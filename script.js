...
retakeBtn.addEventListener("click", async () => {
  ...
  async function uploadPhoto() { 
    if (!imageData) { status.innerHTML = "⚠️ No photo to upload."; return; }
    ...
    try {
      ...
      const response = await fetch( "https://api.cloudinary.com/v1_1/sfnq6tmp/image/upload", {
      ...
      if (data.secure_url) { 
        ...
        alert("Photo uploaded successfully!"); status.innerHTML = "✅ Upload successful!"; 
